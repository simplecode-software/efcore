...
WHERE [o].[CustomerID] IS NOT NULL AND ([o].[CustomerID] LIKE N'T%')");
        }
...
WHERE [o].[CustomerID] IS NOT NULL AND ([o].[CustomerID] LIKE N'Q%')
...
FROM [Orders] AS [o]
LEFT JOIN [Order Details] AS [o0] ON [o].[OrderID] = [o0].[OrderID]
WHERE [o].[CustomerID] IS NOT NULL AND ([o].[CustomerID] LIKE N'G%')
