...
namespace Microsoft.EntityFrameworkCore.Query
{
        ...
        where TFixture : NorthwindQueryFixtureBase<NoopModelCustomizer>, new()
    {
        ...
        public virtual Task Include_reference_and_collection_order_by(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Order>().Where(o => o.CustomerID.StartsWith("A")).Include(o => o.Customer.Orders).OrderBy(o => o.OrderID),
        ...
        public virtual async Task Include_references_then_include_collection(bool async)
        {
            await AssertQuery(
                async,
                ss => ss.Set<Order>().Where(o => o.CustomerID.StartsWith("A")).Include(o => o.Customer).ThenInclude(c => c.Orders),
                elementAsserter: (e, a) => AssertInclude(
                    e, a,
        ...
        public virtual Task Include_collection(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(c => c.CustomerID.StartsWith("C")).Include(c => c.Orders),
        ...
        public virtual Task Include_collection_alias_generation(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Order>().Where(o => o.CustomerID.StartsWith("G")).Include(o => o.OrderDetails),
        ...
        public virtual Task Include_collection_and_reference(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Order>().Where(o => o.CustomerID.StartsWith("G")).Include(o => o.OrderDetails).Include(o => o.Customer),
                elementAsserter: (e, a) => AssertInclude(
                    e, a,
        ...
        public virtual Task Include_collection_on_additional_from_clause(bool async)
        {
            return AssertQuery(
                ...
                ss => from c1 in ss.Set<Customer>().OrderBy(c => c.CustomerID).Take(5)
                      from c2 in ss.Set<Customer>().Where(c2 => c2.CustomerID.StartsWith("G")).Include(c2 => c2.Orders)
                      select c2,
                elementAsserter: (e, a) => AssertInclude(e, a, new ExpectedInclude<Customer>(c => c.Orders)),
                entryCount: 42);
        }
        ...
        public virtual Task Include_collection_order_by_key(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(c => c.CustomerID.StartsWith("H")).Include(c => c.Orders).OrderBy(c => c.CustomerID),
                elementAsserter: (e, a) => AssertInclude(e, a, new ExpectedInclude<Customer>(c => c.Orders)),
                assertOrder: true,
                entryCount: 60);
        }
        ...
        public virtual Task Include_collection_order_by_non_key(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(c => c.CustomerID.StartsWith("H")).Include(c => c.Orders).OrderBy(c => c.PostalCode),
                elementAsserter: (e, a) => AssertInclude(e, a, new ExpectedInclude<Customer>(c => c.Orders)),
                assertOrder: true,
                entryCount: 60);
        }
        ...
        public virtual Task Include_collection_order_by_non_key_with_skip(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(c => c.CustomerID.StartsWith("W")).Include(c => c.Orders).OrderBy(c => c.ContactTitle).Skip(2),
                elementAsserter: (e, a) => AssertInclude(e, a, new ExpectedInclude<Customer>(c => c.Orders)),
                entryCount: 37);
        }
        ...
        public virtual Task Include_reference(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Order>().Where(o => o.CustomerID.StartsWith("T")).Include(o => o.Customer),
        ...
        public virtual Task Include_reference_and_collection(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Order>().Where(o => o.CustomerID.StartsWith("Q")).Include(o => o.Customer).Include(o => o.OrderDetails),
                elementAsserter: (e, a) => AssertInclude(
                    e, a,
                    new ExpectedInclude<Order>(o => o.Customer),
                    new ExpectedInclude<Order>(o => o.OrderDetails)),
        ...
        public virtual Task Include_reference_when_entity_in_projection(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Order>().Where(o => o.CustomerID.StartsWith("A")).Include(o => o.Customer).Select(o => new { o, o.CustomerID }),
        ...
        public virtual Task Include_collection_then_include_collection(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(c => c.CustomerID.StartsWith("Q")).Include(c => c.Orders).ThenInclude(o => o.OrderDetails),
                elementAsserter: (e, a) => AssertInclude(
                    e, a,
                    new ExpectedInclude<Customer>(c => c.Orders),
                    new ExpectedInclude<Order>(o => o.OrderDetails, "Orders")),
        ...
        public virtual Task Include_collection_then_include_collection_then_include_reference(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>().Where(c => c.CustomerID.StartsWith("Q")).Include(c => c.Orders).ThenInclude(o => o.OrderDetails).ThenInclude(od => od.Product),
                elementAsserter: (e, a) => AssertInclude(
                    e, a,
                    new ExpectedInclude<Customer>(c => c.Orders),
                    new ExpectedInclude<Order>(o => o.OrderDetails, "Orders"),
        ...
        public virtual Task Include_collection_with_conditional_order_by(bool async)
        {
            return AssertQuery(
                async,
                ss => ss.Set<Customer>()
                    .Where(c => c.CustomerID.StartsWith("L"))
                    .Include(c => c.Orders)
